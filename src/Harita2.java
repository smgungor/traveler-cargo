 ...
 * @author ONUR
 */
public class Harita2 extends javax.swing.JFrame {
    ...
    public Harita2(int []toplamil2,int[][] tümpixel2,int [][] gidilenplaka2) {
        initComponents();
        toplamil=toplamil2;
        tümpixel=tümpixel2;
        gidilenplaka=gidilenplaka2;
    }
    @Override
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Harita3 yeni = new Harita3(toplamil,tümpixel,gidilenplaka);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Harita2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
